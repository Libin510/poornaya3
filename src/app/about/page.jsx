...
export default function Navbar() {
  ...
  const team = [
    { name: "Micheal Nguyen N.S.W", role: "Licensed Clinical Social Worker", img: "/user3.png" },
    { name: "Micheal Nguyen N.S.W", role: "Licensed Clinical Social Worker", img: "/user4.png" },
    { name: "Nguyen N.S.W", role: "Licensed Clinical Social Worker", img: "/user4.png" },
    { name: "Micheal W", role: "Licensed Clinical Social Worker", img: "/user4.png" },
  ...
  const prev = () => setCurrent((prev) => (prev === 0 ? team.length - 2 : prev - 1));

  const qualifications = [
    { icon: Shield, title: "Restrictive Practice Frameworks", description: "Expert Knowledge In Managing And Reducing Restrictive Interventions" },
    { icon: BookOpen, title: "Functional Behaviour Assessments", description: "Comprehensive Training In Analyzing Behavioral Patterns" },
    { icon: Heart, title: "Trauma-Informed Care", description: "Specialized Approaches For Supporting Trauma Survivors" },
    { icon: Brain, title: "Mental Health First Aid", description: "Certified In Both Youth And Adult Mental Health Support" },
    { icon: Scale, title: "Forensic Support", description: "Extensive Experience In Justice-Involved Settings" },
    { icon: Search, title: "Investigation Techniques", description: "Professional Training In Interviewing And Investigation" },
  ];
    ...
    <div className="p-2 flex flex-col gap-20 bg-gradient-to-r from-[#FBFBFB] to-[#EFF3D0]">
      ...
      <div className="px-6 md:px-16 flex flex-col gap-10">
        ...
        <p className="text-center lg:text-left font-medium text-lg sm:text-xl leading-relaxed">
          Behind <span className="text-[#003A11] font-bold">Poornaya’s</span> success is Wish, an exceptionally dedicated Behaviour Support Practitioner,{" "}
          <span className="text-[#003A11] font-bold">Physiotherapist</span>, and{" "}
          <span className="text-[#003A11] font-bold">Social Worker</span>. With qualifications earned in{" "}
          <span className="text-[#003A11] font-bold">Australia and New Zealand</span>, and more than a decade of clinical experience.
        </p>

        <div className="grid grid-cols-1 lg:grid-cols-3 text-center gap-10 mb-10">
          {content.map((item) => (
            <div key={item.title} className="flex flex-col gap-1">
              <p className="text-3xl text-[#003A11] font-semibold">{item.value}</p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-8">
              <button onClick={prev} className="w-10 h-10 rounded-md bg-green-800 text-white flex items-center justify-center hover:bg-green-900">
                <ChevronLeft size={20} />
              </button>
              <button onClick={next} className="w-10 h-10 rounded-md bg-green-800 text-white flex items-center justify-center hover:bg-green-900">
          ...
          <div className="flex gap-4 justify-center md:justify-end">
            {[team[current], team[current + 1]].map((item, idx) => (
              item && (
                <div key={idx} className="w-[250px] sm:w-[280px] md:w-[320px] transition-all">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-xl h-[400px] sm:h-[500px]">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col justify-end p-6 md:p-8">
              <h2 className="text-3xl md:text-5xl font-bold text-white">Training &<br />Qualifications</h2>
                ...
                {index === 0 ? (
                  <div className="space-y-4">
                    ...
                    <div className="relative rounded-2xl overflow-hidden shadow-lg">
                      <img src={value.image} className="w-full h-64 object-cover" />
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end">
                        <div className="p-6 flex items-end justify-between">
                          <p className="text-white text-sm flex-1">{value.description}</p>

                          <button className="bg-green-900 hover:bg-green-800 text-white px-6 py-2 rounded-full text-sm">
                            Get Started
                          </button>
                        </div>
                      </div>
